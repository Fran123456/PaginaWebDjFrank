            ...
            <div class="panel panel-default">
              <div class="panel-heading">
                <div class="text-center">
                  ...
                  <p>INDICACIÓN: Para mejor orden en la página web solo agregar 4 ofertas o
                  en efecto agregar parejas es decir 4 ofertas, 8 ofertas, 12 ofertas.</p>
                  <h2><img class="text" src="img/admin/store.png" height="80" width="80" alt=""></h2>
                  <a href="{{ route('ofertas.create') }}" class=" btn btn-sm btn-primary">
                      Crear
                  </a>
                </div>
              </div>
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $category->name }}</td>
                                <td width="10px">
                                    <a href="{{ route('ofertas.show', $category->id) }}" class="btn btn-sm btn-default">Ver</a>
                                </td>
                                <td width="10px">
                                    <a href="{{ route('ofertas.edit', $category->id) }}" class="btn btn-sm btn-default">Editar</a>
                                </td>
                                <td width="10px">
                                    {!! Form::open(['route' => ['ofertas.destroy', $category->id], 'method' => 'DELETE']) !!}
