            ...
            <div class="panel panel-default">
              <div class="panel-heading">
                <div class="text-center">
                  <h2>Lista de mejores diseños</h2>
                  <h2><img class="text" src="img/admin/mejordesing.png" height="80" width="80" alt=""></h2>
                  <a href="{{ route('PostMejor.create') }}" class=" btn btn-sm btn-primary">
                      Crear
                  </a>
                </div>
              </div>
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $post->name }}</td>
                                <td width="10px">
                                    <a href="{{ route('PostMejor.show', $post->id) }}" class="btn btn-sm btn-default">Ver</a>
                                </td>
                                <td width="10px">
                                    <a href="{{ route('PostMejor.edit', $post->id) }}" class="btn btn-sm btn-default">Editar</a>
                                </td>
                                <td width="10px">
                                    {!! Form::open(['route' => ['PostMejor.destroy', $post->id], 'method' => 'DELETE']) !!}
